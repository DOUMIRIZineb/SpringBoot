...
//----------------------------------- Get my current IP adresse -----------------------------------------------------------------//
    //still not complete!!!!! à revoir ce code !
...
//--------------------------------- ExtractLocalIps fonction -----------------------------//
    //we use a thread to find devices in background !
